            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Vergangener Buchungsverlauf</h3>
                  <h6>Hier finden Sie alle vergangene Buchungen, die Sie jemals getätigt haben</h6>
                </div>
