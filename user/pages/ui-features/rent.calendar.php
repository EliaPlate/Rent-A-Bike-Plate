    ...
    $(document).ready(function() {
      var calendar = $('#calendar').fullCalendar({
        ...
        eventClick: function(event) {
          console.log(event);
          var start = (event.start == null ? "Unbekannt" : $.fullCalendar.formatDate(event.start, "DD-MM-Y HH:mm:ss"));
          var end = (event.end == null ? "Unbekannt" : $.fullCalendar.formatDate(event.end, "DD-MM-Y HH:mm:ss"));
