      ...
      <div class="errors">
        ...
        if (isset($_GET['error'])) {
          if ($_GET['error'] == "INVALID") {
            echo "<div id='error__input'>Es konnte keine Gerät gefunden werden! Überprüfen Sie die Eingabe.</div>";
          }
        }
        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Gerät suchen</h3>
          ...
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <input type="text" id="user__edit__input" name="device__gestellnummer__value" placeholder="ID eingeben" onblur="this.placeholder = 'ID eingeben'" onfocus="this.placeholder = ''">
                    </div>
            ...
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class=" card card-dark-blue" style="background: linear-gradient(TO RIGHT, #5f0a87, #4B49AC);">
                <div class="card-body">
                  <p class="mb-4" style="font-size: 25px; text-align: center; font-family: monospace;">Name</p>
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <input type="text" id="user__edit__input" name="name__value" placeholder="Name eingeben" onblur="this.placeholder = 'Name eingeben'" onfocus="this.placeholder = ''">
                    </div>
                    <input id="user__edit__submit" type="submit" value="Suchvorgang starten">
                  </form>
                </div>
            ...
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class=" card card-dark-blue" style="background: linear-gradient(TO RIGHT, #5f0a87, #4B49AC);">
                <div class="card-body">
                  <p class="mb-4" style="font-size: 25px; text-align: center; font-family: monospace;">Klassen Art</p>
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <div class="text__field">
                        <?php
                        echo '<select  name="class_name__value">';
                        $query = $conn->query("SELECT Art FROM klasse");
                        while ($row = $query->fetch_assoc()) {
                          echo "<option name='class_name__value' value='" . $row['Art'] . "'>" . $row['Art'] . "</option>";
                        }
                        echo "</select>";
                        ?>
                        <input id="user__edit__submit" type="submit" value="Suchvorgang starten">
            ...
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class=" card card-dark-blue" style="background: linear-gradient(TO RIGHT, #5f0a87, #4B49AC);">
                <div class="card-body">
                  <p class="mb-4" style="font-size: 25px; text-align: center; font-family: monospace;">Station</p>
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <div class="text__field">
                        <?php
                        echo '<select  name="station__value">';
                        $query = $conn->query("SELECT * FROM ausleihstation");
                        while ($row = $query->fetch_assoc()) {
                          echo "<option value='" . $row['Station_id'] . "'>" . $row['Straße'] . " - " . $row['PLZ'] . " - " . $row['Station_id'] . "</option>";
                        }
                        echo "</select>";
                        ?>
                        <input id="user__edit__submit" type="submit" value="Suchvorgang starten">
                              ...
                              if ($device != null) {
                                ...
                                if (count($device) >= 2) {
                                  foreach ($device as $data) {
                                    $realDevice = getDevice($conn, $data);
                            ?>
                                    <tr style=" border-bottom: 1px solid #808080; text-align: center !important;">

                                      <td><?php echo $realDevice['Gestellnummer'] ?></td>
                                      <td><?php echo $realDevice['name'] ?></td>
                                      <td><?php echo getClass($conn, $realDevice['Klasse_id'])['Art'] ?></td>
                                      <td><?php echo getStation($conn, $realDevice['Station_id'])['Straße'] . " - " . getTownFromId($conn, getStation($conn, $realDevice['Station_id'])['PLZ'])["Name"] ?></td>
                                  ...
                                  $realDevice = getDevice($conn, $device[0]);
                                  ?>
