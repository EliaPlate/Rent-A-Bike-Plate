      ...
      <div class="errors">
        ...
        if (isset($_GET['error'])) {
          if ($_GET['error'] == "INVALID") {
            echo "<div id='error__input'>Es konnte kein Kunde gefunden werden! Überprüfen Sie die Eingabe.</div>";
          }
        }
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Kunde suchen</h3>
          ...
          <div class="row">
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class=" card card-dark-blue" style="background: linear-gradient(TO RIGHT, #5f0a87, #4B49AC);">
                <div class="card-body">
                  <p class="mb-4" style="font-size: 25px; text-align: center; font-family: monospace;">Kunden ID</p>
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <input type="text" id="user__edit__input" name="member__id__value" placeholder="Kunden ID eingeben" onblur="this.placeholder = 'Kunden ID eingeben'" onfocus="this.placeholder = ''">
                    </div>
            ...
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class=" card card-dark-blue" style="background: linear-gradient(TO RIGHT, #5f0a87, #4B49AC);">
                <div class="card-body">
                  <p class="mb-4" style="font-size: 25px; text-align: center; font-family: monospace;">Vorname</p>
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <input type="text" id="user__edit__input" name="member__firstname__value" placeholder="Vorname eingeben" onblur="this.placeholder = 'Vorname eingeben'" onfocus="this.placeholder = ''">
                    </div>
                    <input id="user__edit__submit" type="submit" value="Suchvorgang starten">
                  </form>
                </div>
            ...
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class=" card card-dark-blue" style="background: linear-gradient(TO RIGHT, #5f0a87, #4B49AC);">
                <div class="card-body">
                  <p class="mb-4" style="font-size: 25px; text-align: center; font-family: monospace;">Nachname</p>
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <input type="text" id="user__edit__input" name="member__lastname__value" placeholder="Nachname eingeben" onblur="this.placeholder = 'Nachname eingeben'" onfocus="this.placeholder = ''">
                    </div>
                    <input id="user__edit__submit" type="submit" value="Suchvorgang starten">
                  </form>
                </div>
            ...
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class=" card card-dark-blue" style="background: linear-gradient(TO RIGHT, #5f0a87, #4B49AC);">
                <div class="card-body">
                  <p class="mb-4" style="font-size: 25px; text-align: center; font-family: monospace;">EMail</p>
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <input type="text" id="user__edit__input" name="member__email__value" placeholder="EMail eingeben" onblur="this.placeholder = 'EMail eingeben'" onfocus="this.placeholder = ''">
                    </div>
                    <input id="user__edit__submit" type="submit" value="Suchvorgang starten">
                  </form>
                </div>
            ...
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class=" card card-dark-blue" style="background: linear-gradient(TO RIGHT, #5f0a87, #4B49AC);">
                <div class="card-body">
                  <p class="mb-4" style="font-size: 25px; text-align: center; font-family: monospace;">Wohnort</p>
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <div class="text__field">
                        <?php
                        echo '<select  name="member_town__value">';
            ...
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class=" card card-dark-blue" style="background: linear-gradient(TO RIGHT, #5f0a87, #4B49AC);">
                <div class="card-body">
                  <p class="mb-4" style="font-size: 25px; text-align: center; font-family: monospace;">Rolle</p>
                  <form action="search.inc.php" method="POST">
                    <div class="user__edit__container">
                      <div class="text__field">
                        <?php
                        echo '<select  name="member_role__value">';
                              ...
                              if ($member != null) {
                                ...
                                if (count($member) >= 2) {
                                  foreach ($member as $data) {
                                    $realMember = getMember($conn, $data);
                            ?>
                                    <tr style=" border-bottom: 1px solid #808080; text-align: center !important;">

                                      <td><?php echo $realMember['Kunde_id'] ?></td>
                                      <td><?php echo $realMember['Vorname'] ?></td>
                                      <td><?php echo $realMember['Nachname'] ?></td>
                                      <td><?php echo $realMember['Telefonnummer'] ?></td>
                                      <td><?php echo $realMember['Email'] ?></td>
                                      <td><?php echo $realMember['Straße'] ?></td>
                                      <td><?php echo getTownFromId($conn, $realMember['PLZ'])['Name'] ?></td>
                                      <td><?php echo getRoleFromIdFromDataBase($conn, $realMember['role_id'])['name'] ?></td>
                                  ...
                                  $realMember = getMember($conn, $member[0]);
                                  ?>
