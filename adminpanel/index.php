        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="pages/ui-features/user.delete.php">Kündigen</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/all.members.php">Alle Kunden</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/all.members.no.admins.php">Kunden o. Admin</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/search.repair.php">Reparatur</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/search.device.php">Gerät</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/search.member.php">Kunde</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/search.place.php">Ausleihstation</a></li>
              </ul>
            </div>
          </li>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">10 Neusten Kunden</p>
                  <div class="row">
                    <div class="col-12">
                      <div class="table-responsive">
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <tbody>
                            <?php
                            $id = $_SESSION['userid'];
                            $query = $conn->query("SELECT * FROM kunde ORDER BY Kunde_id DESC LIMIT 10");
